  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center" }}>
        {/* <Typography.Title level={4} style={{ margin: 0, color: "#001529" }}>
          CodingMSTR
        </Typography.Title> */}
      </div>
      <div style={{ display: "flex", alignItems: "center" }}>
        <Badge count={4} style={{ marginRight: 24 }}>
          <MailOutlined style={{ fontSize: 24, color: "#1890ff" }} />
        </Badge>
        <Badge count={17} style={{ marginRight: 24 }}>
...
//         >
//           <Menu.Item key="1" icon={<MenuOutlined />} onClick={() => {}}>
//             Menu
//           </Menu.Item>
//         </Menu>
//         <Title
